...
private:
    ...
    static void generateValidCandidates(const Graph* data_graph, ui depth, ui* embedding, ui* idx_count, vector<vector<ui>>& valid_candidate,
    ...
    static void generateValidCandidates(const Graph *query_graph, const Graph *data_graph, ui depth, ui *embedding,
                                            ...
                                            ui *order, ui *pivot);
    static void generateValidCandidates(ui depth, ui *embedding, ui *idx_count, vector<vector<ui>>& valid_candidates, ui *order,
